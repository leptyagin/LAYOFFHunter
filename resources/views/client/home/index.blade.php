...
@section('content')
    <div class="home-page">
        <div class="home-inner">
            <h1>Welcome to my <strong>laravel</strong> project</h1>
            <p class="mt-5">
                Это мой пет проект с забавным названием <a href="{{ route('client.home.index') }}">layoff hunter</a> (охотник за увольнениями),<br>
                который представляет собой маленькую копию сервиса <a target="_blank" href="https://hh.ru">Head Hunter</a>. <br>
            </p>

            <p class="mt-3">
                Здесь можно посмотреть открытые вакансии в компаниях<br>
                ознакомится с описанием вакансии, посмотреть предлагаемую зарплату<br>
                и связаться по оставленным контактам
            </p>

            <p class="mt-3">
                <a href="{{ route('client.vacancy.index') }}">
            ...
            <div class="mt-5 link">
                <a class="social-link v-toolbar" href="https://t.me/leptyagin" target="_blank">
                    <svg fill="#ddd" width="30px" height="30px" viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1"
            ...
            <div class="mt-1 link">
                <a href="https://github.com/leptyagin" class="social-link v-toolbar" target="_blank">
